...
<div class="rx-slider">
    @foreach($banners as $banner)
        <div class="rx-slide" 
             style="background-image: url('{{ asset('/public/platina/home/banner/' . $banner->banner_images) }}'); 
                    background-size: cover; 
                    background-position: center;">

            {{-- Foreground image (if needed for effect) --}}
            <img src="{{ asset('/public/platina/home/banner/' . $banner->banner_images) }}" 
                 alt="hero-box" 
  ...
  <div class="container">
    <div class="row mb-minus-24">
      ...
      @foreach ($texts as $index => $text)
        <div class="col-xl-4 col-lg-6 col-sm-6 col-12 mb-24 rx-575-50"
             data-aos="flip-left"
          ...
          <div class="rx-services">
            <div class="services-ico">
              <img src="{{ asset('public/platina/home/brandethos/' . ($images[$index] ?? 'default.png')) }}"
...
<section class="section-room padding-tb-50">
  <div class="container">
    <div class="row mb-minus-24 room-popup justify-content-center">
      <div class="col-12 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1000">
        <div class="rx-banner text-center rx-banner-effects">
          <p>
            <img src="{{ asset('/frontend/assets/img/banner/left-shape.svg')}}" alt="banner-left-shape" class="svg-img left-side">
            {{ $materials->title ?? '' }}
      ...
      @foreach($texts as $index => $text)
      <div class="col-lg-3 col-sm-6 col-12 mb-24 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="{{ $index * 200 }}">
        <div class="rx-rooms-main-box">
          <div class="rooms-box-front">
            <img src="{{ asset('public/platina/home/materials/' . trim($images[$index] ?? '')) }}" alt="room-{{ $index + 1 }}">
          ...
          <div class="rooms-box-back">
            <img src="{{ asset('public/platina/home/materials/' . trim($images[$index] ?? '')) }}" alt="rooms-{{ $index + 1 }}">
            <div class="content-wrap">
 ...
 <section class="section-team padding-tb-50">
    <div class="container">
      <div class="row">
        <div class="col-12" data-aos="fade-up" data-aos-duration="1000">
          <div class="rx-banner text-center rx-banner-effects">
            <p><img src="{{ asset('/frontend/assets/img/banner/left-shape.svg')}}" alt="banner-left-shape" class="svg-img left-side">Weaves
            <img src="{{ asset('/frontend/assets/img/banner/right-shape.svg')}}" alt="banner-right-shape" class="svg-img right-side"></p>
            <h4>Tailored<span> Luxury Weaves</span></h4>
          </div>
        </div>
        <div class="col-12" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
          <div class="owl-carousel weaves-slider-sec">
            <div class="rx-team-card">
              <div class="rx-spa-card">
                <div class="spa-img">
                  <img src="{{ asset('/frontend/assets/img/spa/webp/percale-cotton.webp')}}" alt="spa-1">
                </div>
                <div class="spa-contact">
                  <h4>Percale</h4>
                  <p>A crisp, closely woven weave with a matte finish and cool touch. Percale offers breathable comfort, perfect for those who prefer a smooth, hotel-like feel.</p>
                </div>
              </div>
            </div>
            <div class="rx-team-card">
              <div class="rx-spa-card">
                <div class="spa-img">
                  <img src="{{ asset('/frontend/assets/img/spa/webp/satin.webp')}}" alt="spa-2">
                </div>
                <div class="spa-contact">
                  <h4>Satin</h4>
                  <p>With a glossy surface and fluid drape, satin exudes luxury and softness. Its smooth texture adds a touch of elegance to everyday indulgence.</p>
                </div>
              </div>
            </div>
            <div class="rx-team-card">
              <div class="rx-spa-card">
                <div class="spa-img">
                  <img src="{{ asset('/frontend/assets/img/spa/webp/sateen.webp')}}" alt="spa-3">
                </div>
                <div class="spa-contact">
                  <h4>Sateen</h4>
            ...
            <div class="rx-team-card">
              <div class="rx-spa-card">
                <div class="spa-img">
                  <img src="{{ asset('/frontend/assets/img/spa/webp/jacquard.webp')}}" alt="spa-4">
                </div>
                <div class="spa-contact">
                  <h4>Jacquard</h4>
                  <p>Woven with intricate patterns directly into the fabric, Jacquard offers rich texture and design. It’s a sophisticated weave that blends artistry with craftsmanship.</p>
                </div>
              </div>
            </div>
            <div class="rx-team-card">
              <div class="rx-spa-card">
                <div class="spa-img">
                  <img src="{{ asset('/frontend/assets/img/spa/webp/yarn-dyed-chambray.webp')}}" alt="spa-5">
                </div>
                <div class="spa-contact">
                  <h4>Yarn-Dyed Chambray</h4>
                  <p>Made by weaving dyed yarns, this lightweight fabric has a soft, denim-like appearance. Chambray offers casual charm with depth of color and breathable ease.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row mb-minus-24">
              <div class="col-lg-8 col-12 mb-24">
                <div class="rx-amenities-img">
                  <img src="{{ asset('public/platina/home/Premium/' . trim($images[$index] ?? 'default.webp')) }}" alt="amenities-{{ $index + 1 }}">
                </div>
              </div>
            ...
            <div class="row mb-minus-24">
              <div class="col-md-4 col-12 mb-24">
                <div class="rx-testimonials-img">
                  <img src="{{ asset('public/platina/home/testimonials/' . ($images[$index] ?? 'default.webp')) }}" alt="testimonial-{{ $index + 1 }}">
                </div>
              </div>
          ...
          @for ($i = 0; $i < $count; $i++)
            <div class="rx-blog-card">
              <div class="rx-blog-img">
                @if (!empty($images[$i]))
                  <img src="{{ asset('public/platina/home/blogs/' . $images[$i]) }}" alt="blog-{{ $i + 1 }}">
                @else
