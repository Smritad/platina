  ...
  <div class="col-lg-6 col-12 mb-24">
    ...
    <div class="row">
        ...
        <div class="col-12 mb-24">
            <div class="rx-input-box">
                <input type="text" name="subject" class="rx-form-control" placeholder="Subject" >
            </div>
        </div>
        <div class="col-12 mb-24">
            <div class="rx-input-box">
...
function validateRecaptcha() {
    ...
    if (response.length == 0) {
        document.getElementById('captcha-error').innerText = 'Please verify that you are not a robot.';
        return false;
    }
    return true;
}
