  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 col-12" data-aos="fade-up" data-aos-duration="1000">
        ...
        <h3>{{ $about->content_heading ?? '' }}</h3>
      </div>
    </div>

    <div class="row">
      @foreach($extraImages as $index => $img)
      <div class="col-xl-3 col-lg-6 col-sm-6 col-12" data-aos="flip-left" data-aos-duration="1000" data-aos-delay="{{ $index * 200 }}">
        <div class="rx-services">
          <div class="services-ico">
            <img src="{{ asset('uploads/platina_brand/'.$img) }}" alt="service-{{ $index+1 }}" class="svg-img">
          </div>
          <div class="services-contact">
            <h6>{{ $contentHeadingDescriptions[$index] ?? '' }}</h6>
          </div>
        </div>
      </div>
      @endforeach
...
<p style="line-height: 1.8;">
  {!! str_replace('relaxation and beauty.', 'relaxation and beauty.<br><br>', $about->content_description ?? '') !!}
</p>
        ...
        <div class="col-lg-6 col-12 mb-24" data-aos="fade-up" data-aos-duration="1000">
          <div class="rx-about-img">
            <img src="{{ asset('uploads/platina_brand/'.$about->content_image) }}" alt="about-image" class="rx-white-img">
          </div>
        </div>
      </div>
    </div>
