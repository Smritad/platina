    ...
    <div class="page-body">
        <div class="container-fluid">
            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-6">
                        <h4>Add Materials Details</h4>
                    </div>
                    <div class="col-6 text-end">
                        <ol class="breadcrumb justify-content-end">
                            <li class="breadcrumb-item"><a href="{{ route('material-details.index') }}">Home</a></li>
                            <li class="breadcrumb-item active">Add Materials Details</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <!-- Form Start -->
            <form action="{{ route('material-details.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
