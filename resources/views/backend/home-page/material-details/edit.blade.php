    ...
    <div class="page-body">
        <div class="container-fluid">
            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-6">
                        <h4>Edit Materials Details</h4>
                    </div>
                    <div class="col-6 text-end">
                        <ol class="breadcrumb justify-content-end">
                            <li class="breadcrumb-item"><a href="{{ route('material-details.index') }}">Home</a></li>
                            <li class="breadcrumb-item active">Edit Materials Details</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <!-- Form Start -->
            <form action="{{ route('material-details.update', $brandEthosDetails->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        @foreach($counterItems as $index => $item)
                            <div class="row g-3 align-items-center counter-group mb-3">
                                ...
                                <div class="col-md-2 text-center">
                                    @if(!empty($item['image']))
                                        <img src="{{ asset('public/platina/home/materials/' . $item['image']) }}" class="img-preview rounded" style="max-width: 80px; max-height: 80px;">
                                    @else
                ...
                <div class="text-end mt-4">
                    <a href="{{ route('material-details.index') }}" class="btn btn-danger">Cancel</a>
