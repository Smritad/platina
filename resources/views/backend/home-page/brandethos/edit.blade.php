...
<body>
    ...
    <div class="page-body">
        <div class="container-fluid">
            ...
            <!-- Form Card -->
            <form action="{{ route('brand-ethos-details.update', $brandEthosDetails->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="card">
                    ...
                    <div class="card-body row g-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="title" id="title" value="{{ $brandEthosDetails->title }}" required>
                        </div>

                        <div class="col-md-6">
                            <label for="heading" class="form-label">Heading <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="heading" id="heading" value="{{ $brandEthosDetails->heading }}" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mt-4">
                    <div class="card-header bg-primary text-white">
                        <strong>Section 2: Counter Text, Description & Image</strong>
                    </div>
                    <div class="card-body">
                        <div id="counterWrapper">
                            ...
                            <div class="row g-3 align-items-center counter-group mb-3">
                                ...
                                <div class="col-md-2 text-center">
                                    <img src="{{ asset('/public/platina/home/brandethos/' . $item['image']) }}" class="img-preview rounded" style="max-width: 80px; max-height: 80px;" />
                                </div>
