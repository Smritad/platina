								...
								<nav aria-label="breadcrumb" role="navigation">
									<ol class="breadcrumb mb-0">
										<li class="breadcrumb-item">
											<a href="{{ route('blogs-details.index') }}">Home</a>
										</li>
										<li class="breadcrumb-item active" aria-current="page">Blogs Details</li>
									</ol>
								</nav>

								<a href="{{ route('blogs-details.create') }}" class="btn btn-primary px-5 radius-30">+ Add Blogs Details</a>
							</div>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('blogs-details.edit', $record->id) }}" class="btn btn-sm btn-primary">Edit</a>
                     ...
                     <br><br><form action="{{ route('blogs-details.destroy', $record->id) }}" method="POST" style="display:inline-block;">
                        @csrf
                        @method('DELETE')
