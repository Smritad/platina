    ...
    <div class="page-body">
        <div class="container-fluid">
            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-6">
                        <h4>Edit Return Policy Details</h4>
                    </div>
                    <div class="col-6 text-end">
                        <ol class="breadcrumb justify-content-end">
                            <li class="breadcrumb-item"><a href="{{ route('manage-return-policy.index') }}">Home</a></li>
                            <li class="breadcrumb-item active">Edit Return Policy Details</li>
                        </ol>
                    </div>
                </div>
            </div>
             ...
             <!-- Form -->
            <form action="{{ route('manage-return-policy.update', $record->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
