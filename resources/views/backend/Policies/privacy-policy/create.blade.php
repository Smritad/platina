...
<body>
    ...
    <div class="page-body">
        <div class="container-fluid">
            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-6">
                        <h4>Add Privacy Policy Details</h4>
                    </div>
                    <div class="col-6 text-end">
                        <ol class="breadcrumb justify-content-end">
                            <li class="breadcrumb-item"><a href="{{ route('privacy-policy.index') }}">Home</a></li>
                            <li class="breadcrumb-item active">Add Privacy Policy Details</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <form action="{{ isset($record) ? route('privacy-policy.update', $record->id) : route('privacy-policy.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
