      ...
      <div class="row mb-minus-24">
            ...
            <div class="rx-items-contact">
              <ul>
                <!-- <li><a href="#" class="line-hover">FAQ’s</a></li> -->
                 <li><a href="{{ route('contact.us') }}" class="line-hover">Contact Us</a></li>
        ...
        <div class="col-lg-2 col-sm-4 col-6 col-420-full mb-24 footer-order-4">
          <div class="rx-footer-items">
            ...
            <div class="rx-items-contact">
              <ul>
                <li><a href="{{ route('coming.soon') }}">Bed Sheets</a></li>
                <li><a href="{{ route('coming.soon') }}">Comforters</a></li>
                <li><a href="{{ route('coming.soon') }}">Quilts</a></li>
                <li><a href="{{ route('coming.soon') }}">Duvet Covers</a></li>
                <li><a href="{{ route('coming.soon') }}">Pillow Covers</a></li>
                <li><a href="{{ route('coming.soon') }}">Cushion Covers</a></li>
                <li><a href="{{ route('coming.soon') }}">Quilt Sets</a></li>
              </ul>
            </div>
          </div>
        </div>
