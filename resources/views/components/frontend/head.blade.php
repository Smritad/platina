...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Platina India">
    <meta name="keywords" content="Platina India">
    <title>Platina India</title>
    <!-- site Favicon -->
    <link rel="icon" href="{{ asset('/frontend/assets/img/favicon/favicon.webp')}}" type="image/x-icon">
    ...
    <link rel="stylesheet" href="{{ asset('frontend/assets/css/vendor/jquery.fancybox.min.css')}}">
    ...
    <link rel="stylesheet" href="{{ asset('frontend/assets/css/vendor/owl.carousel.min.css')}}">
