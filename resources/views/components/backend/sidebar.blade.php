          ...
          <nav class="sidebar-main">
            ...
            <div id="sidebar-menu">
              ...
              <li class="sidebar-list {{ request()->routeIs('collections.index', 'product-category.index', 'product-fabrics.index', 'fabric-composition.index', 'product-sizes.index', 'product-prints.index', 'product-details.index') ? 'active' : '' }}">
                  ...
                  <ul class="sidebar-submenu">
                    <li><a href="{{ route('product-category.index') }}" class="{{ request()->routeIs('product-category.index') ? 'active' : '' }}"> Masters Category</a></li>
                                        <li><a href="{{ route('product-subcategory.index') }}" class="{{ request()->routeIs('product-subcategory.index') ? 'active' : '' }}"> Sub Category</a></li>
                    <li><a href="{{ route('age-group.index') }}" class="{{ request()->routeIs('age-group.index') ? 'active' : '' }}"> Age Group</a></li>
                    <li><a href="{{ route('fabric-type.index') }}" class="{{ request()->routeIs('fabric-type.index') ? 'active' : '' }}"> Fabric Type</a></li>
                    <li><a href="{{ route('product-size.index') }}" class="{{ request()->routeIs('product-size.index') ? 'active' : '' }}"> Product Size</a></li>
                    <li><a href="{{ route('product-content.index') }}" class="{{ request()->routeIs('product-content.index') ? 'active' : '' }}"> Product Content</a></li>
