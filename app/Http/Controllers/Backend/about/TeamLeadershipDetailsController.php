   ...
   public function store(Request $request)
{
    ...
    $socialIcons = $request->social_icons ? implode('|', $request->social_icons) : ''; // Use | to avoid conflict with internal commas
    ...
    return redirect()->route('team-leadership.index')->with('message', 'Team Leadership details saved!');
}
   ...
   public function update(Request $request, $id)
{
    ...
    return redirect()->route('team-leadership.index')->with('message', 'Team detail updated successfully!');
}
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('team-leadership.index')->with('message', 'Deleted successfully!');
    }
}
