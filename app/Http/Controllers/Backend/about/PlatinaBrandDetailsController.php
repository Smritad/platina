    ...
    public function store(Request $request)
{
    ...
    $data = $request->only([
        'title', 'description', 'content_heading', 'content_description'
    ]);

    // Convert array descriptions to comma-separated string
    ...
    // Upload and save multiple extra images
    ...
    return redirect()->route('platina-brand.index')->with('message', 'Platina Brand detail added successfully!');
}
   ...
   public function update(Request $request, $id)
{
    ...
    // Convert array of content heading descriptions to comma-separated string
    $data['content_heading_descriptions'] = implode(',', $request->content_heading_descriptions);
    ...
    // Handle extra images (combine existing + new)
    ...
    return redirect()->route('platina-brand.index')->with('message', 'Platina Brand detail updated successfully!');
}
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('platina-brand.index')->with('message', 'Deleted successfully!');
    }
}
