...
{
    $premiumDetails = PremiumDetail::latest()->get(); // Fetch all records
...
public function store(Request $request)
{
    ...
    return redirect()->route('Premium-details.index')
                     ->with('message', 'Premium details added successfully!');
}
...
public function edit($id)
{
    ...
    // Explode counter fields (stored as comma-separated values)
...
public function update(Request $request, $id)
{
    ...
    $newImages = $request->file('counter_image'); // Note: May be null if no files uploaded
...
{
    $record = PremiumDetails::findOrFail($id);
